...
% A BW of 30 g was assumed based on the mean value of female CD1 mice
antiPDL1_10mgkg_SD = getIDperMl(antiPDL1_10mgkg_SD, 300);
antiPDL1_10mgkg_MD = getIDperMl(antiPDL1_10mgkg_MD, 300);
antiPDL1_1mgkg_MD = getIDperMl(antiPDL1_1mgkg_MD, 30);
antiCTLA4_10mgkg_MD = getIDperMl(antiCTLA4_10mgkg_MD, 300);
antiCTLA4_1mgkg_MD = getIDperMl(antiCTLA4_1mgkg_MD, 30);
%% Generate PI.data
