...
%% Parameter setup
parameters = {'S_L';'kin_CD8';'KDE_MDSC';'kpro_Tumor'; 'kill_CD8'; 'kin_Treg' ;...
    'kin_DC';'kin_MDSC';'f3'; 'kpro_Tumor_Linear'; 'kill_Treg';'K_PDL1';'K_CTLA4'};
...
lb=([1e-3   1e-3    1e-3   1e-3    1e-6    1e-3     1e-3    1e-3    1e-3    1e-4    1e-6    1e0    1e0 ])';
ub=([1e3    1e3     1e3    10      1e3     1e3      1e3     1e3     1       1e3     1e3     1e7     1e4 ])';
