...
lb=([1e-2   1e-3   1e-3   1e-3    1e-2 1e-5    1e-3 1e-1    1e-3     1e-3 1e-2    10      1e-3    ])';
ub=([1e2    1e2    1e2    1e2     2e0  1e1     1    1e3     2e2      10   1e2     1e3     1       ])';
...
%% Save results
save('PI_CIM30_MOC2_red.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM30_MOC2_red.mat'},'\'),'PI')
