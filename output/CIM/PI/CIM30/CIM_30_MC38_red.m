...
lb=([1e-2   1e-3   1e-3   1e-4    1e-3    1e-2 1e-5    1e-3 1e-2   1e-1    1e-4    1e-4   1e-4   0.01    1e-2    10      ])';
ub=([1e2    1e2    1e2    1e2     1e2     2e0  1e1     1    1e2    1e3     1e3     1e4    1e2    100     1e2     1e3     ])';
...
%% Save results
save('PI_CIM30_MC38_red.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM30_MC38_red.mat'},'\'),'PI')
