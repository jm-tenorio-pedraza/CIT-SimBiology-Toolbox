...
initialStruct = struct('name', {'MOC1';'MOC2';'MC38'}, 'initialValue', {5; 0.1; 0.1},...
    'variant', {variants(11); variants(12); variants(10)});
...
%% Parameter setup
parameters = {'kin_CD8'; 'kin_Treg';...
    'kin_MDSC';'kpro_Tumor'; 'kpro_Tumor_Linear'; 'kill_CD8'; 
    'K_MDSC'; 'K_PDL1';'ks_PDL1_Tumor';...
    'ks_PDL1_Immune'; 'kill_Treg';  'kin_CD45';...
    'K_IFNg'; 'kdeg_PDL1'; };
...
PI.observablesFields = {'TV'  'CD8'  'Treg' 'DCm'...
    'MDSC' 'CD8_E' 'PDL1_T' 'PDL1_I'};
PI.normIndx = 6:8;
PI.model = 'CIM Control Progressor';
...
lb=([1e-2   1e-3   1e-4    1e-3    1e-2 1e-5    1e-3 1e-2   1e-4    1e-4   1e-4    1e-3     0.01    1e-2     ])';
ub=([1e2    1e2    1e2     1e2     2e1  1e1     1    1e2    1e5     1e5    1e2     2e2      100     1e2      ])';
...
%% Save results
save('PI_CIM30_MOC1_Progressor_red.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM30_MOC1_Progressor_red.mat'},'\'),'PI')
