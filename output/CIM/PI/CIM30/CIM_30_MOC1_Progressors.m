...
respIndx = strcmp({PI.data(:).Response}, 'Progressor');
...
[sim,PI.u]=initializePI(model,parameters,observables,PI,doses, ...
    'PKPD_Fit_MOC1_CTLA4_PDL1_MDSC_Treg_Responder','doseUnits', 'mole');
...
%% Save results
save('PI_CIM30_MOC1_Progressor.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM30_MOC1_Progressor.mat'},'\'),'PI')
