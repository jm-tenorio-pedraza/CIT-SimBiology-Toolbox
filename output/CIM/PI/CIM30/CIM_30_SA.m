...
if ispc
    ...
    out = sbioloadproject('/Users/migueltenorio/Documents/GitHub/sbio-projects/CIM_9.sbproj');
...
parameters = {'kin_CD8'; 'kin_Treg';'K_IFNg';'KDE_MDSC';'K_MDSC'; 'kin_DC';...
    ...
    'ks_PDL1_Immune'; 'kill_Treg'; 'kdep_max'; 'kin_TIC'; 'kdeg_PDL1'; 'kdeg_CTLA4';
    };
...
[sim,PI.u]=initializePI(model,parameters,observables,PI,doses, 'CT26','doseUnits', 'mole');
...
lb=([1e-3   1e-3    1e-3    1e-4    1e-5   1e-3   1e-4    1e-3    1 1e-5    1e-5     10      10     1e-5    1e-5    1e0     1e0    1e-4    0.01  1e0 1e-2 1e-2])';
ub=([2e3    1e3     1e2     1e1     1e1    1e3    1e3     1e2     1e2 1e3     1e1      1e4     1e6    1e2     1e2     1e4     1e4    1e2     100   1e3 1e2 1e2])';
