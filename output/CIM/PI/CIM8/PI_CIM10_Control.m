...
%% Parameter setup
parameters = {'kin_CD8';'kin_DC'; 'kin_Treg'; ...
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [6 7 8] , 'cell_indx',[4:5], 'n_indiv', length(PI.u));
SigmaNames = getVarNames(PI, stateVar);
[beta, sigma_prior] = getVarValues([1 1 .001], [1, 1 0.001], [1 1 1], PI);

lb=([1e-3    1e-3    1e-3   1e-2     1e-2    1e-2   1e-2    1e-3])';
ub=([1e2     1e2     1e2    1e2      1e2     1e1    1e2     1e2])';
...
%% Save results
save('PI_CIM10_Control_11.mat', 'PI')
load(strjoin({cd 'PI_CIM10_Control_10.mat'},'/'),'PI')
