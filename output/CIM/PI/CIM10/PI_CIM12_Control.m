...
%% Parameter setup
parameters = {'kin_CD8';'kin_DC'; 'kin_Treg';'K_IFNg';'S_R';'S_L'; 'K_MDSC'; ...
...
%% Save results
save('PI_CIM11_Control_0.mat', 'PI')
