...
%% Parameter setup
parameters = {'kin_CD8';'kin_DC'; 'kin_Treg';'K_IFNg';'KDE_MDSC'; 'K_MDSC'; ...
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [] , 'cell_indx',[7:11], 'n_indiv', length(PI.u));
SigmaNames = getVarNames(PI, stateVar);
[beta, sigma_prior] = getVarValues([1 1 .001], [1, 1 0.001], [1 1 1], PI);

lb=([1e-3    1e-3    1e-3   1e-3    1e-4 1e-3   1e-3    1e-3    1e-2   1e-2     1e-3])';
ub=([1e2     1e2     1e2    1e2     1e1  1e1    1e2     1e2     1e1    1e2  1e3])';
...
%% Save results
save('PI_CIM18_Control_0.mat', 'PI')
