...
parameters = {'kin_CD8'; 'K_IFNg'; 'KDE_MDSC'; 'K_MDSC';'kin_MDSC'; 'kin_TIC';...
    ...
    'K_PDL1'; 'kill_Treg'};
parameters = [parameters;  'T_0'; 'antiLy6G_on'];

% Define outputs% Define outputs
groups_subset = {'MOC1_8Gyx2' 'MOC1_2Gyx10' 'MOC1_antiPD1_8Gyx2' 'MOC1_antiPD1_2Gyx10'...
    'MOC1_antiCTLA4_antiLy6G' 'MOC1_antiLy6G_antiPDL1'...
    'MOC1_antiLy6G'...
    'MOC2_antiLy6G' 'MOC2_antiLy6G_antiPDL1'...
...
PI.normIndx = [];
PI.model = 'CIM22 ICB Validation set';
...
[PI.x_0, PI.variants] = getInitialValues([PI.data(:).Group],...
    initialStruct);
PI.x_0 = [PI.x_0 repelem(1,length(PI.data),1)];
% Get simulation function
[sim,~]=initializePI(model, parameters,observables, PI,doses,...
    'MOC1_optimized','doseUnits', 'mole');
PI.u = getDoseSchedule(PI, {'Blood.Dose_antiPDL1', 'Blood.Dose_antiCTLA4'},...
    'startTime', [7 7],'freq', [5 5], 'numDoses', [3 3], 'dose', [0.0013 6.6667e-4],...
    'doseUnits', 'mole');
%% Optimization setup
% Hierarchical structure
PI.H = getHierarchicalStruct(parameters(1:end-2),PI,'n_sigma', length(PI.observablesPlot),...
...
varIndx_CIM = [1:6 11:12 14:15 43:44];
varIndx_ICB =   [1:8 10 9 11 15:18 20 19 21 25:28 30 29 31 35:38 39:42];
