...
save(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_J3.mat'},''), 'J3')
save(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_n_id3.mat'},''), 'n_id3')
save(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_pCR3.mat'},''), 'pCR3')

load(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_x_3.mat'},''))
load(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_p_x_3.mat'},''))
load(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_J3.mat'},''))
load(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_n_id3.mat'},''))
load(strjoin({cd '/PI_CIM21_ICB_1_DREAM_MCMC_pCR3.mat'},''))
