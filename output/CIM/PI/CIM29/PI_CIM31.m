...
if ispc
    ...
    out = sbioloadproject('\Users\jmten\OneDrive\Dokumente\GitHub\sbio-projects\CIM_9.sbproj');
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [] , 'cell_indx',[ 2 6 7 10 ], 'n_indiv', length(PI.u));
...
%% Save results
save('PI_CIM31_0.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM31_0.mat'},'\'),'PI')
