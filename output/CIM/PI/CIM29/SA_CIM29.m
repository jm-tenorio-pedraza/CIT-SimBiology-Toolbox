...
if ispc
    ...
    out = sbioloadproject('\Users\jmten\OneDrive\Dokumente\GitHub\sbio-projects\CIM_7.sbproj');

else
    addpath(genpath('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox'))
    cd('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox/output/CIM/PI/CIM29')
    out = sbioloadproject('/Users/migueltenorio/Documents/GitHub/sbio-projects/CIM_7.sbproj');
...
parameters = {'kin_CD8'; 'kin_Treg';'K_IFNg';'KDE_MDSC';'K_MDSC'; 'kin_DC';...
    ...
    'ks_PDL1_Immune'; 'kill_Treg'; 'kdep_max'; 'KDE_Treg'; 'kin_TIC'; 'kel_Naive';
    'kel_Effector'; 'kel_Treg'; 'kel_Ag'; 'kel_DC'; 'kel_MDSC'; ...
    'kdeg_CTLA4'; 'kdeg_PDL1'; 'kdif'; 'kpro_CD8';  };
...
lb=([1e-3   1e-3    1e-3    1e-4    1e-5   1e-3   1e-4    1e-3    1e-2  1e-5    1e-5     10      10     1e-5    1e-5    1e0     1e0    1e-4    0.01     1e-1 1e0 1e-2   1e-1    1e-1    1e0     1e-2    1e-2    1e-2    1e-2    1e-1    1e-2])';
ub=([2e3    1e3     1e2     1e1     1e1    1e3    1e3     1e2     1e2   1e3     1e1      1e4     1e6    1e2     1e2     1e4     1e4    1e2     100       1e2 1e3 1e1    1e1     1e1     1e2     1e1     1e1     1e2     1e2     1e1     1e1])';
...
%% Save results
save('PI_CIM29_0.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM29_0.mat'},'\'),'PI')
