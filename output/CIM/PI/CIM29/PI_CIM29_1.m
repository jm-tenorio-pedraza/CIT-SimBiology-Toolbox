...
%% Parameter setup
parameters = {'kin_CD8'; 'kin_Treg';'K_IFNg';'KDE_MDSC';'kin_DC';...
    'kin_MDSC';'kpro_Tumor'; 'kpro_Tumor_Linear';'kill_CD8'; 
     'K_CTLA4'; 'K_PDL1'; 'S_L';'S_R'; 'ks_PDL1_Tumor';...
    'ks_PDL1_Immune'; 'kill_Treg'; 'kdep_max';  'kin_TIC'; 'kel_Naive';
    'kel_Effector'; 'kel_Treg';...
    'kdeg_PDL1'; 'kdif'; 'kpro_CD8';};
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [] , 'cell_indx',[2 5 6  8], 'n_indiv', length(PI.u));
SigmaNames = getVarNames(PI, stateVar);
[beta, sigma_prior] = getVarValues([.01 .01 .001], [.01 .01 .001], [1 1 1], PI);
lb=([1e-3   1e-3    1e-3    1e-4    1e-3   1e-4    1e-3    1e-2  1e-5   10      10     1e-5    1e-5    1e0     1e0    1e-4    0.01     1e0 1e-2   1e-1    1e-1       1e-2    1e-2    1e-1])';
ub=([2e3    1e3     1e2     1e1     1e3    1e3     1e2     1e2   1e3    1e4     1e6    1e2     1e2     1e4     1e4    1e2     100      1e3 1e1    1e1     1e1        1e2     1e2     1e1])';
...
%% Save results
save('PI_CIM29_1_0.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM29_1_0.mat'},'\'),'PI')
