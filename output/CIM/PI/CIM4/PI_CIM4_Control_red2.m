...
cd('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox/output/CIM/PI/CIM4')
...
parameters = {'kin_CD8'; 'K_CD8';'KDE_MDSC';'K_CTLA4'; ...
    ...
    'K_MDSC';'kin_MDSC';'kin_DC';'f3';'T_max'; 'kpro_Tumor_Linear'};
...
PI.observablesPlot={'TV' 'CD8' 'CD107a' 'Treg' 'DCm'...
    'MDSC' 'PDL1_T' 'PDL1_I'};
...
sigma_prior= [ repelem(1,length(PI.H.PopulationParams), 1);...
    ...
    alpha];
lb=([1e-3    1e-6    1e-6    1   1e-3    1e-6    1e-3    1e-3    1e-3    1e-3    1e-3    0.01    0.1    1e-4])';
ub=([1e3     1e6     1e3     1e3 10      1e3     1e3     1e3     1       1e3     1e3     10      3100   1])';
...
prior = {'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U' 'U'};
...
params = [{PI.H.CellParams(:).name}'; {PI.H.IndividualParams(:).name}'];
table(params(cell_indx), w)
%% Save results
save('PI_CIM4_Control_red2.mat', 'PI')
load(strjoin({cd 'PI_CIM4_Control_red2.mat'},'/'),'PI')
