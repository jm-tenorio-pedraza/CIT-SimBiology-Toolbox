...
parameters = {'kin_CD8'; 'K_CD8';'KDE_MDSC';'K_CTLA4'; ...
    ...
    'K_MDSC';'kin_MDSC';'kin_DC';'kill_Treg';'f3';'T_max'; 'kpro_Tumor_Linear'};
...
sigma_prior= [ repelem(1,length(PI.H.PopulationParams), 1);...
    ...
    alpha];
lb=([1e-3    1e-6    1e-6    1   1e-3    1e-6    1      1e-3    1e-3    1e-3    1e-3    1e-3    1e-6     0.01    0.1    1e-4])';
ub=([1e3     1e6     1e3     1e3 10      1e3     1e5	1e3     1e3     1       1e3     1e3     1e6      10      3100   1])';
...
%% Save results
save('PI_CIM4_Control_red1.mat', 'PI')
