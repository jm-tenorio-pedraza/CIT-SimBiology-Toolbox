...
if ispc
    ...
    cd('\Users\jmten\OneDrive\Dokumente\GitHub\CIT-SimBiology-Toolbox\output\CIM\PI\CIM28')
    out = sbioloadproject('\Users\jmten\OneDrive\Dokumente\GitHub\sbio-projects\CIM_6.sbproj');

else
    addpath(genpath('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox'))
    cd('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox/output/CIM/PI/CIM28')
...
parameters = {'kin_CD8'; 'kin_Treg';'K_IFNg';'KDE_MDSC';'K_MDSC'; 'kin_DC';...
    ...
    'ks_PDL1_Immune'; 'kill_Treg'; 'kdep_max'; };
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [9] , 'cell_indx',[1 6 7 8  10  15   ], 'n_indiv', length(PI.u));
SigmaNames = getVarNames(PI, stateVar);
[beta, sigma_prior] = getVarValues([.01 .01 .001], [.01 .01 .001], [1 1 1], PI);
lb=([1e-3   1e-3    1e-3    1e-4    1e-5   1e-3   1e-4    1e-3    1e-2  1e-5    1e-5   1e0     10      10    1e-5    1e-5    1e0     1e0    1e-4    0.01])';
ub=([2e3    1e3     1e2     1e1     1e1    1e3    1e3     1e2     1e2   1e3     1e1    1e2      1e4     1e5       1e2     1e2     1e4     1e4    1e2     10])';
...
%% Save results
save('PI_CIM28_0.mat', 'PI')
if ispc
    load(strjoin({cd 'PI_CIM28_3.mat'},'\'),'PI')
