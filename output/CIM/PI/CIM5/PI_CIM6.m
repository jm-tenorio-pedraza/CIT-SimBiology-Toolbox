...
parameters = {'kin_CD8'; 'K_CD8';'KDE_MDSC';'K_CTLA4'; ...
    ...
    'K_MDSC';'kin_MDSC';'kin_DC';'f3'; 'kpro_Tumor_Linear'; 'K_PDL1'};
...
sigma_prior= [ repelem(1,length(PI.H.PopulationParams), 1);...
    ...
    alpha];
lb=([1e-3    1e-6    1e-6    1   1e-3    1e-6    1e-3    1e-3    1e-3    1e-3    1e-3    0.01    1e-4   1e2])';
ub=([1e3     1e6     1e3     1e4 10      1e3     1e3     1e3     1       1e3     1e3     10      1      1e6])';
