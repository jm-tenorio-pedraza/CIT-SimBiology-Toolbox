...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [4 8 9 10 11 12] , 'cell_indx',[], 'n_indiv', length(PI.u));
...
sigma_prior= [ repelem(1,length(PI.H.PopulationParams), 1);...
    ...
    alpha];
lb=([1e-3    1e-6    1   1e-3    1e-6    1e-3    1e-3    1e-3    1e-3    1e-3    0.01    1e-4])';
ub=([1e3     1e3     1e3 10      1e3     1e3     1e3     1       1e3     1e3     10      1])';
...
%% Save results
save('PI_CIM5_Control_red2.mat', 'PI')
