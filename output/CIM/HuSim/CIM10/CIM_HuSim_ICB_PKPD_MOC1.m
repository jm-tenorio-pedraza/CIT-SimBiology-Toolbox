...
kproTumorLinear_indx=ismember(parameters,{'kpro_Tumor_Linear' 'kdep_max'});
Theta(:,kproTumorLinear_indx)=-log(1e10);
%% Scaling parameters
...
%% Save output
save(strjoin({cd '/CIM/HuSim/CIM10/HumanPI_MOC1.mat'},''),'HumanPI')

%% Load HumanPI
HumanPI=load(strjoin({cd '/CIM/HuSim/CIM10/HumanPI_MOC1.mat'},''));