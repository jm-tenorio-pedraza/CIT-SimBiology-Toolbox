...
MODEL = 'TwoCompartment with TMDD';
...
parameters = {'Blood'; 'Tumor';'CL_antiPDL1'; 'Q23';...
    'PDL1_Tumor'; 'kdeg_PDL1';'PDL1_Blood'; 'ID'};
% Define outputs
...
lb = [1e-1   1e-4   1e-2    1e-3   1e3     1e-2    1e3 ];
ub = [1e1    1      1e2     1e2    2e6     1e1     2e6 ];
...
load(strjoin({cd 'PI_PK_TwoComp4_5_TMDD_0.mat'},'/'))
