...
parameters = {'Blood'; 'T_0';'Peripheral';'CL_antiPDL1';'Q12';...
 ...
 % Define outputs
observables={'ID_g_Blood_antiPDL1_Id' ...
    'ID_g_Tumor_antiPDL1_Id' };
if ispc
...
PI.observablesPlot = {'Blood Serum antiPDL1_{Total}' ...
    'Tumor antiPDL1_{Total}' };
PI.observablesFields = {'Blood_Serum_Total',...
    'Tumor_Total'};
dose = {'Blood.antiPDL1'};
PI.normIndx = [];
...
lb = [1e-1   1      1e-1    1e-2    1e-2    1e-1    1e-2     1e-2   1e-3    1e-3 0.1];
ub = [1e1    1e3    1e1     1e1     1e2     1e2     1e1      1e1    0.1     0.2  0.9];
...
%% Save results
save('PI_PK_ThreeComp10_B16F10_4T1.mat', 'PI')
%%
load(strjoin({cd 'PI_PK_ThreeComp10_B16F10_4T1.mat'},'/'))
%%
%% save MCMC results
N_i='7';
