...
if ispc
    ...
    out = sbioloadproject('\Users\jmten\OneDrive\Dokumente\GitHub\sbio-projects\CIM_10_1_PK_3.sbproj');

else
    addpath(genpath('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox'))
    cd('/Users/migueltenorio/Documents/GitHub/CIT-SimBiology-Toolbox/output/PK_mAb_ThreeComp/PI/ThreeComp_10')
    out = sbioloadproject('/Users/migueltenorio/Documents/GitHub/sbio-projects/CIM_10_1_PK_3.sbproj');
...
parameters = {'Blood'; 'T_0';'Peripheral';'CL_antiPDL1';'Q12';...
     'PDL1_Tumor_ss'; 'kdeg_PDL1';'kint'; 'krec_PDL1'; 'f_L'; 'V_vs'; 
     'ID_antiPDL1'};
...
PI.H = getHierarchicalStruct3(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [],'cell_indx',[2 10],'resp_indx', [],'n_indiv', length(PI.u),'CellField', 'Name');

% Generating PI
SigmaNames = getVarNames(PI, observables);
[beta, sigma_prior] = getVarValues([.1 .1 .001 ], [.1 .1 0.001 ], [1 1 1], PI);
lb = [1e-1   1      1e-1    1e-6   1e-2    1e-1    1e-2 1e-2     1e-2     1e-3    1e-3 ];
ub = [1e1    1e3    1e1     1e1     1e2     1e2    1e1 1e1      1e1      0.1     0.2  ];
...
%% Save results
save('PI_PK_3_B16OVA_NT25.mat', 'PI')
%%
load(strjoin({cd 'PI_PK_ThreeComp10_B16OVA_NT25.mat'},'/'))
%%
%% save MCMC results
N_i='7';
