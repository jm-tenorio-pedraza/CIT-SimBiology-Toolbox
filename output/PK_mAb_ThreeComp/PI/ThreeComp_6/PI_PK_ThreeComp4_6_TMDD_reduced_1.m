...
parameters = {'Blood'; 'Tumor';'Peripheral';'CL_antiPDL1'; 'Q23'; ...
     'Q12';'kdeg_PDL1';  'PDL1_Peripheral';'ID'};
% Define outputs
...
lb = [1e-3   1e-3   1e-3    1e-4    1e-4 1e-4   1e-3 1e0 ];
ub = [1e1    2      1e1     1e1     1e1 1e1    1e1  1e6 ];
...
%% Save results
save('PI_PK_ThreeComp4_6_TMDD_reduced_1_0.mat', 'PI')
%% LOAD RESULTS
load(strjoin({cd 'PI_PK_ThreeComp4_6_TMDD_reduced_2_0.mat'},'/'))
