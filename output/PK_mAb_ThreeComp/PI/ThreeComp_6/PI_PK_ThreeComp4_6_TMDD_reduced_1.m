...
parameters = {'Blood'; 'Tumor';'Peripheral';'CL_antiPDL1'; 'Q23'; ...
     'PDL1_Tumor'; 'kdeg_PDL1';  'PDL1_Peripheral';'ID'};
% Define outputs
...
lb = [1e-1   1e-3   1e-3    1e-5    1e-5   1e0 1e-3 1e0 ];
ub = [1e1    2      1e1     1e1     1e1    1e6 1e0  1e6 ];
...
%% Save results
save('PI_PK_ThreeComp4_6_TMDD_reduced_0.mat', 'PI')
