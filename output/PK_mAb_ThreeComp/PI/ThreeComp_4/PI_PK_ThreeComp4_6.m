...
parameters = {'Blood'; 'Tumor';'Peripheral';'CL'; 'Q23';'Q12';'PDL1_Tumor'; 'kdeg_PDL1'; 'PDL1_Blood'; 'PDL1_Peripheral'; 'ID'};
% Define outputs
...
lb = [1e-1   1e-3   1e-3    1e-2    1e-3   1e-3     1e3     1e-2 1e3 1e3];
ub = [1e1    2      1e1     1e1     1e1    1e1      1e6     1e1  1e6 1e6];
...
%% Save results
save('PI_PK_ThreeComp4_6_TMDD_0.mat', 'PI')
