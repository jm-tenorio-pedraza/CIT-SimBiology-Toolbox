...
parameters = {'Blood'; 'Tumor';'CL'; 'Q23'; 'Peripheral'; 'Q12';'kint'; 'PDL1_Tumor';'PDL1_Blood';'ID'};
% Define outputs
...
PI.H = getHierarchicalStruct(parameters(1:end-1),PI,'n_sigma', length(observables),...
    'rand_indx', [],'cell_indx',[3], 'n_indiv', length(PI.u),'CellField', 'Name');

% Generating PI
SigmaNames = getVarNames(PI, observables);
[beta, sigma_prior] = getVarValues([1 1 .001], [1, 1 0.001], [1 1 1], PI);
lb = [1e-3  1e-3    1e-3    1e-5    1e-3    1e-4    1e-4    1e0     1e0];
ub = [1e1   1e1     1e2     1e1     1e2     1e1     1e1     1e6     1e6];
...
%% Save results
save('PI_PK_ThreeComp4_TMDD_8.mat', 'PI')
load(strjoin({cd 'PI_PK_TwoComp4_2_1.mat'},'/'))
