...
MODEL = 'TwoCompartment without TMDD';
variants = get(model,'variants');
%% Setting up parameters, data and simulations

parameters = {'Blood'; 'Tumor';'CL_antiPDL1'; 'Q23'; 'ID'};
% Define outputs
...
%% Save results
save('PI_PK_TwoComp4_4_wo_TMDD_0.mat', 'PI')
load(strjoin({cd 'PI_PK_TwoComp4_4_wo_TMDD_0.mat'},'/'))
