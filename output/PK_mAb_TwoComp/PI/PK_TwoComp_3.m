...
parameters = {'Blood'; 'CL'; 'Q23'; 'PDL1_0'; 'ID'};
% Define outputs
...
[PI,PI.u]=getDataSets(dataset_file_ext, 'subsetVariables', {'Blood_antiPDL1__ID_g_'...
    'Tumor_antiPDL1__ID_g_' 'Blood_antiPDL1_free__ID_g_' 'Tumor_antiPDL1_free__ID_g_' 'Tumor_to_Blood__' });
PI.variableUnits={'%ID/g'  '%ID/g' '%ID/g' '%ID/g' '[]' };
PI.observablesPlot = {'ID_g_Blood' 'ID_g_Tumor' 'ID_g_Blood_free' 'ID_g_Tumor_free' 'T2B' };
