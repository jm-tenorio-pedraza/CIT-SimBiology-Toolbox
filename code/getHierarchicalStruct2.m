function H = getHierarchicalStruct2(params, PI, varargin)
p=inputParser;
...
n_celltypes = length(celltypes)-1;
...
try
    ...
    CellIndx = reshape([CellIndx{:,:}],n_indiv+1,n_celltypes+1);
    H.CellIndx = CellIndx;
catch
